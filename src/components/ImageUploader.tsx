    ...
    >
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <AnimatePresence mode="wait">
          <AnimatedStep isVisible={currentStep === "input"} stepKey="input">
            <motion.div
              key="input"
          ...
          <AnimatedStep isVisible={currentStep === "loading"} stepKey="loading">
            <Card className="shadow-lg max-w-2xl mx-auto">
          ...
          <AnimatedStep isVisible={currentStep === "output"} stepKey="output">
